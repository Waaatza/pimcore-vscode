...
export class RouteDefinitionTreeItem extends AbstractContainerTreeItem {
    ...
    constructor(routeDefinition: RouteDefinition, displayPath: boolean = false) {
        super(
            displayPath
                ? `${routeDefinition.path} [${routeDefinition.method}]`
                : routeDefinition.id,
        ...
        this.tooltip = `${routeDefinition.path} [${routeDefinition.method}]`;
    }
    ...
    get childrenItems(): vscode.TreeItem[] {
        ...
        if (this._displayPath) {
            ...
            children.push(
                new vscode.TreeItem(
                    "Path: " + this._routeDefinition.path,
                    vscode.TreeItemCollapsibleState.None
                )
            );
        }
        ...
        children.push(
            new vscode.TreeItem(
                "Method: " + this._routeDefinition.method,
                vscode.TreeItemCollapsibleState.None
            )
        );
        ...
        children.push(
            new vscode.TreeItem(
                "Action: " + this._routeDefinition.action,
                vscode.TreeItemCollapsibleState.None
            )
        );
